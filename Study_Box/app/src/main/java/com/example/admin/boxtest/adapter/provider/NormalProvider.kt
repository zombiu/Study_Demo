...
import com.example.admin.boxtest.adapter.NORMAL_ITEM
 ...
 * 普通布局
 */
class NormalProvider :BaseItemProvider<NormalMultipleEntity,BaseViewHolder>() {
    var tagList = mutableListOf("无限道具", "无敌", "秒杀")
    override fun layout(): Int {
        return R.layout.top_item_normal
    }
