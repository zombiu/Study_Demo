 ...
 */
public class NestedScrollViewTest extends FrameLayout implements NestedScrollingParent3,
    ...
    public interface OnScrollChangeListener {
         ...
         */
        void onScrollChange(NestedScrollViewTest v, int scrollX, int scrollY,
    ...
    public NestedScrollViewTest(@NonNull Context context) {
        this(context, null);
    }

    public NestedScrollViewTest(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            case MotionEvent.ACTION_MOVE: {
                ...
                if (yDiff > mTouchSlop
                    ...
                    LogUtils.e("-->>onInterceptTouchEvent  ACTION_MOVE 拦截" + " ,对象=" + this);
                }
                LogUtils.e("-->>onInterceptTouchEvent  ACTION_MOVE  mIsBeingDragged=" + mIsBeingDragged + " ,对象=" + this);
                break;
            }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (actionMasked) {
            case MotionEvent.ACTION_DOWN: {
                ...
                XLog.e("-->>onTouchEvent MotionEvent.ACTION_DOWN ,接收的对象=" + this);
                if (mIsBeingDragged) {
                    final ViewParent parent = getParent();
                    if (parent != null) {
                        parent.requestDisallowInterceptTouchEvent(true);
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                XLog.e("-->>onTouchEvent MotionEvent.ACTION_MOVE ,接收的对象=" + this);
                ...
                if (!mIsBeingDragged && Math.abs(deltaY) > mTouchSlop) {
                    ...
                    LogUtils.e("-->>准备move deltaY=" + deltaY + " ,对象=" + this);
                }
                if (mIsBeingDragged) {
    ...
    static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle arguments) {
            ...
            final NestedScrollViewTest nsvHost = (NestedScrollViewTest) host;
